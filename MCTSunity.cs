...
public class MCTSunity
{
    Helperunity helper = new Helperunity();
    ...
    public unsafe byte GetBestMove(Gameunity game, int player)
    {
    ...
    public Node Selection(Node current, Gameunity game)
    {
    ...
    public Node Expand(Node current, Gameunity game)
    {
    ...
    public int Rollout(Node current, Gameunity game, int startPlayer)
    {
        helper.CopyBytes(game.board, current.state);
